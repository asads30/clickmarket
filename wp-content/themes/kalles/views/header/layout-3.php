	...
	<div class="header__mid pl__15 pr__15<?php echo esc_attr( ( cs_get_option( 'header-transparent' ) ? ' header__transparent pa w__100' : '' ) ); ?>">
        <div class="container">
			<div class="row middle-xs al_center">
				<div class="col-md-5 col-2 dn_lg">
				...
				<div class="col-lg-3 col-md-2 col-8 tc tl_lg">
					<?php the4_kalles_logo(); ?>
				</div>
				<div class="col-lg-7 col-md-6 col-12 dn db_lg">
				...
				<div class="col-lg-auto col-lg-2 col-md-5 col-2 tr col_group_btns">
