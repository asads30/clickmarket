...
//    Custom sections
    ...
    public function get_order_number( $br_order_id ) {
        $meta_array = get_post_meta($br_order_id, '_sequential_order_number', true);
    ...
    public function set_sequential_order_number( $order_id, $data = false ) {
        ...
        $options = parent::get_option();
        $new_order_id = get_post_meta($order_id, '_sequential_order_number_id', true);
        ...
        add_post_meta($order_id, '_sequential_order_number_id', $new_order_id, true);
        ...
        add_post_meta($order_id, '_sequential_order_number', $order_number, true);
        add_post_meta($order_id, '_start_sequential_order_number', $order_number, true);
